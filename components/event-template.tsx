...
import { Calendar, MapPin, Users, Flame, Share2, Heart, ArrowLeft, ChevronDown } from "lucide-react"
...
export function EventTemplate({ event, children }: EventTemplateProps) {
